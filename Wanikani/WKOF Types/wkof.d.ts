...
declare namespace Apiv2 {
    ...
    type LevelProgressions = Record<PropertyKey, never> & Defaults
    type Resets = Record<PropertyKey, never> & Defaults
    type SpacedRepetitionSystems = Record<PropertyKey, never> & Defaults
    type VoiceActors = Record<PropertyKey, never> & Defaults
    ...
    namespace Registry {
        ...
        type Registry = {
            sources: {
                [key: string]: {
                    description: string
                    fetcher: (...arg0: any[]) => Promise<{ [key: string]: any }>
